...
class Apache_environment:
    ...
    return_code = subprocess.run("ab -n 1000 -c 100 -r https://35.165.144.185/ >/home/output.txt 2>&1",shell=True)
    line = ""
    req_per_second = ""
    ...
    def get_reward(self,cur_state,total_requests,concurrent_requests):
        ...
        if return_val.returncode == 0:
            ab_command = "ab -n " +str(total_requests) + " -c " + str(concurrent_requests) + " -r https://35.165.144.185/ >/home/output.txt 2>&1"
